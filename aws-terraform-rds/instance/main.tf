...
resource "aws_cloudwatch_log_group" "this" {
  ...
  name              = "/aws/rds/instance/${var.identifier}/${each.value}/${lower(random_string.default.result)}"
...
resource "aws_iam_role" "enhanced_monitoring" {
  ...
  name                 = "${local.monitoring_role_name}-${lower(random_string.default.result)}"
  ...
  tags = merge(
    {
      "Name" = "${var.monitoring_role_name}-${lower(random_string.default.result)}"
    },
    var.tags,
  )
}
